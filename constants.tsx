...
export const WEDDING_CONFIG = {
  ...
  registry: {
    ...
    gifts: [
      { id: '1', name: 'Peralatan Dapur Set', price: 'RM 300', reserved: false, image: 'https://images.unsplash.com/photo-1590794056226-79ef3a8147e1?auto=format&fit=crop&q=80&w=600', buyLink: 'https://shopee.com.my/search?keyword=kitchenware%20set' },
      { id: '2', name: 'Tempat Tidur Queen', price: 'RM 1500', reserved: false, image: 'https://images.unsplash.com/photo-1522771739844-6a9f6d5f14af?auto=format&fit=crop&q=80&w=600', buyLink: 'https://shopee.com.my/search?keyword=queen%20bed' },
      { id: '3', name: 'Periuk Nasi Premium', price: 'RM 400', reserved: false, image: 'https://images.unsplash.com/photo-1544233726-9f1d2b27bd8b?auto=format&fit=crop&q=80&w=600', buyLink: 'https://shopee.com.my/search?keyword=rice%20cooker%20premium' },
      { id: '4', name: 'Set Pinggan Mangkuk', price: 'RM 250', reserved: false, image: 'https://images.unsplash.com/photo-1603199506016-b9a594b593c0?auto=format&fit=crop&q=80&w=600', buyLink: 'https://shopee.com.my/search?keyword=dinnerware%20set' },
      { id: '5', name: 'Vacuum Cleaner', price: 'RM 600', reserved: false, image: 'https://images.unsplash.com/photo-1558317374-067fb5f30001?auto=format&fit=crop&q=80&w=600', buyLink: 'https://shopee.com.my/search?keyword=vacuum%20cleaner' },
      { id: '6', name: 'Air Fryer', price: 'RM 350', reserved: false, image: 'https://images.unsplash.com/photo-1585238342024-78d387f4a707?auto=format&fit=crop&q=80&w=600', buyLink: 'https://shopee.com.my/search?keyword=air%20fryer' },
    ] as Gift[]
  },
  schedule: [
